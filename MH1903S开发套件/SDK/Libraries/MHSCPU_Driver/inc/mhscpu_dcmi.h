...
/** @defgroup DCMI_DMA_Request_FIFO_Size 
  * @{
  */
#define DCMI_DMARequestFIFOSize_1Word     ((uint32_t)0x20000000) /*!< DCMI FIFO中满一个字就会产生一次DMARequest*/
#define DCMI_DMARequestFIFOSize_2Word     ((uint32_t)0x40000000) /*!< DCMI FIFO中满两个字就会产生一次DMARequest*/
#define DCMI_DMARequestFIFOSize_4Word     ((uint32_t)0x80000000) /*!< DCMI FIFO中满四个字就会产生一次DMARequest*/
