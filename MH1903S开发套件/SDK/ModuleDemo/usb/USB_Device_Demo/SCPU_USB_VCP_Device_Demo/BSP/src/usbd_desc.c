...
#define USBD_PRODUCT_STRING      "Megahunt Virtual ComPort"
#define USBD_SERIALNUMBER_STRING "00000000050B"
...
USBD_DEVICE USR_desc = {
    ...
    USBD_USR_ProductStrDescriptor,      /* Product:Megahunt Virtual ComPort */
