...
#else
	#define INT_PIN  GPIO_ReadInputDataBit(NFC_IRQ_GPIOX, NFC_IRQ_GPIO_PIN) 
#endif

extern transceive_buffer XDATA mf_com_data;
extern u8 XDATA g_led1_on_time;
extern u8 XDATA g_led2_on_time;

void pcd_init(void);
void pcd_reset(void);
int pcd_config(u8 tag_type);
